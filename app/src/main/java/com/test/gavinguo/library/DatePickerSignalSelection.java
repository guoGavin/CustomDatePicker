 ...
 * year, month, and day spinners or a {@link com.test.gavinguo.library.CalendarView}. The set of spinners
 ...
 */
//@Widget
public class DatePickerSignalSelection extends FrameLayout {

    private static final String LOG_TAG = DatePickerSignalSelection.class.getSimpleName();
    ...
    private final NumberPickerSingleSelection mDaySpinner;

    private final NumberPickerSingleSelection mMonthSpinner;

    private final NumberPickerSingleSelection mYearSpinner;
    ...
    public interface OnDateChangedListener {
         ...
         */
        void onDateChanged(DatePickerSignalSelection view, int year, int monthOfYear, int dayOfMonth);
    }

    public DatePickerSignalSelection(Context context) {
        this(context, null);
    }

    public DatePickerSignalSelection(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.datePickerStyle);
    }

    public DatePickerSignalSelection(Context context, AttributeSet attrs, int defStyle) {
        ...
        /*int layoutResourceId = attributesArray.getResourceId(R.styleable.DatePicker_dp_internalLayout,
                R.layout.date_picker_signal_holo);*/
        int layoutResourceId = R.layout.date_picker_signal_holo;
        ...
        NumberPickerSingleSelection.OnValueChangeListener onChangeListener = new NumberPickerSingleSelection.OnValueChangeListener() {
            public void onValueChange(NumberPickerSingleSelection picker, int oldVal, int newVal) {
                updateInputState();
        ...
        // day
        mDaySpinner = (NumberPickerSingleSelection) findViewById(R.id.day);
        mDaySpinner.setFormatter(NumberPickerSingleSelection.getTwoDigitFormatter());
        mDaySpinner.setOnLongPressUpdateInterval(100);
        mDaySpinner.setOnValueChangedListener(onChangeListener);
        mDaySpinnerInput = (EditText) mDaySpinner.findViewById(R.id.np__numberpicker_input);

        // month
        mMonthSpinner = (NumberPickerSingleSelection) findViewById(R.id.month);
        ...
        // year
        mYearSpinner = (NumberPickerSingleSelection) findViewById(R.id.year);
    ...
    /**
     * Gets the minimal date supported by this {@link com.test.gavinguo.library.DatePickerSignalSelection} in
    ...
    /**
     * Sets the minimal date supported by this {@link com.test.gavinguo.library.NumberPicker} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link java.util.TimeZone#getDefault()} time zone.
     *
    ...
    /**
     * Gets the maximal date supported by this {@link com.test.gavinguo.library.DatePickerSignalSelection} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link java.util.TimeZone#getDefault()} time zone.
     * <p>
    ...
    /**
     * Sets the maximal date supported by this {@link com.test.gavinguo.library.DatePickerSignalSelection} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link java.util.TimeZone#getDefault()} time zone.
     *
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(DatePickerSignalSelection.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(DatePickerSignalSelection.class.getName());
    }
    ...
    /**
     * Gets whether the {@link com.test.gavinguo.library.CalendarView} is shown.
     *
    ...
    /**
     * Gets the {@link com.test.gavinguo.library.CalendarView}.
     *
    ...
    /**
     * Sets whether the {@link com.test.gavinguo.library.CalendarView} is shown.
     *
     ...
     */
    private void setImeOptions(NumberPickerSingleSelection spinner, int spinnerCount, int spinnerIndex) {
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link com.test.gavinguo.library.DatePickerSignalSelection#onSaveInstanceState()}
         */
