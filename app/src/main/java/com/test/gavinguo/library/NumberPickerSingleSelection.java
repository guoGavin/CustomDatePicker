...
package com.test.gavinguo.library;
...
import com.test.gavinguo.customdatepicker.R;
 ...
 */
//@Widget
public class NumberPickerSingleSelection extends LinearLayout {
    ...
    /**
     * The {@link com.test.gavinguo.library.Scroller} responsible for flinging the selector.
     */
    private final Scroller mFlingScroller;

    /**
     * The {@link com.test.gavinguo.library.Scroller} responsible for adjusting the selector.
     */
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(NumberPickerSingleSelection picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(NumberPickerSingleSelection view, int scrollState);
    }
     ...
     */
    public NumberPickerSingleSelection(Context context) {
        this(context, null);
    }
     ...
     */
    public NumberPickerSingleSelection(Context context, AttributeSet attrs) {
     ...
     */
    public NumberPickerSingleSelection(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
                ...
                if (Math.abs(initialVelocity) > mMinimumFlingVelocity) {
                    ...
                    if (deltaMoveY <= mTouchSlop) { // && deltaTime < ViewConfiguration.getTapTimeout()) {
                        if (mShowSoftInputOnTap) {
                            ...
                            //这里暂时存在一个bug，就是判断该向上滚动和该向下滚动的时候不正确，暂时判断的都是向下滚动，所以有待改进。
                            int selectorIndexOffset = (eventY / mSelectorElementHeight)
                                    - SELECTOR_MIDDLE_ITEM_INDEX;
                            if (selectorIndexOffset > 0) {
//                                changeValueByOne(true);//禁用这里，则点击控件顶部不会滚动
                                mPressedStateHelper.buttonTapped(
                                        PressedStateHelper.BUTTON_INCREMENT);
                            } else if (selectorIndexOffset < 0) {
//                                changeValueByOne(false);//禁用这里，则点击控件底部不会滚动
                                mPressedStateHelper.buttonTapped(
                                        PressedStateHelper.BUTTON_DECREMENT);
                            }
                        }
     ...
     * <p>
     * If the argument is less than the {@link com.test.gavinguo.library.NumberPickerSingleSelection#getMinValue()} and
     * {@link com.test.gavinguo.library.NumberPickerSingleSelection#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link com.test.gavinguo.library.NumberPickerSingleSelection#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link com.test.gavinguo.library.NumberPickerSingleSelection#getMinValue()} and
     * {@link com.test.gavinguo.library.NumberPickerSingleSelection#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link com.test.gavinguo.library.NumberPickerSingleSelection#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link com.test.gavinguo.library.NumberPickerSingleSelection#getMaxValue()} and
     * {@link com.test.gavinguo.library.NumberPickerSingleSelection#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link com.test.gavinguo.library.NumberPickerSingleSelection#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link com.test.gavinguo.library.NumberPickerSingleSelection#getMinValue()} and
     * {@link com.test.gavinguo.library.NumberPickerSingleSelection#getMaxValue()} values.
     * <p>
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(NumberPickerSingleSelection.class.getName());
...
//        mSelectorTextGapHeight = (int) (totalTextGapHeight / textGapCount + 0.5f);
        mSelectorTextGapHeight = mMaxHeight - mTextSize;//自定义修改
    ...
    /**
     * Posts an {@link com.test.gavinguo.library.NumberPickerSingleSelection.SetSelectionCommand} from the given <code>selectionStart
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            NumberPickerSingleSelection.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            NumberPickerSingleSelection.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
        ...
        public void buttonTapped(int button) {
            ...
            mMode = MODE_TAPPED;
            mManagedButton = button;
            NumberPickerSingleSelection.this.post(this);
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                NumberPickerSingleSelection.this.postDelayed(this,
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                case View.NO_ID: {
                    switch (action) {
                        ...
                        case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                            if (NumberPickerSingleSelection.this.isEnabled()
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (NumberPickerSingleSelection.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (NumberPickerSingleSelection.this.isEnabled()) {
                                NumberPickerSingleSelection.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (NumberPickerSingleSelection.this.isEnabled()) {
                                ...
                                NumberPickerSingleSelection.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setSource(NumberPickerSingleSelection.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(NumberPickerSingleSelection.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
            ...
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setEnabled(NumberPickerSingleSelection.this.isEnabled());
                event.setSource(NumberPickerSingleSelection.this, virtualViewId);
                requestSendAccessibilityEvent(NumberPickerSingleSelection.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText() {
            ...
            info.setSource(NumberPickerSingleSelection.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(NumberPickerSingleSelection.this, virtualViewId);
            info.setParent(NumberPickerSingleSelection.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(NumberPickerSingleSelection.this.isEnabled());
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(NumberPickerSingleSelection.class.getName());
            info.setPackageName(getContext().getPackageName());
            info.setSource(NumberPickerSingleSelection.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(NumberPickerSingleSelection.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(NumberPickerSingleSelection.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(NumberPickerSingleSelection.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
